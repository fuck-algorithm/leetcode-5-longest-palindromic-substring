    ...
    <div className="app-container">
      ...
      <header className="header">
        ...
        <div className="header-controls">
          <a href="https://github.com/fuck-algorithm/leetcode-5-longest-palindromic-substring" target="_blank" rel="noopener noreferrer" className="github-link" title="View on GitHub">
